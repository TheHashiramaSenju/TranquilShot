...
class FusionNode(Node):
    def __init__(self):
        ...
        for name, default in [
            ...
            ('depth_variance_threshold', 0.15), ('size_tolerance', 0.15),
            ('elephant_height_m', 2.5), ('optical_flow_threshold', 0.8),
            ('confidence_threshold', 0.70), ('temporal_persist_frames', 3),
    ...
    def _on_range1(self, msg: Range): self._depth_1 = msg.range
    def _on_range2(self, msg: Range): self._depth_2 = msg.range
    def _on_flow(self,  msg: Float32): self._flow   = msg.data
